...
/* Offset of the recorded code address from the image base. A build states it
 * in its target description; this default lets the probe run standalone. */
#ifndef SLIDE_TRACE_MARK_IP_OFF
#define SLIDE_TRACE_MARK_IP_OFF 0x1f0ac8ULL
#endif
#define IP_TO_TEXT_OFF SLIDE_TRACE_MARK_IP_OFF
#define MARK "KASLR_MARKER_PROBE"
