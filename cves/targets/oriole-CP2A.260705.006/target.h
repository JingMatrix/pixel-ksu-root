// oriole — Pixel 6, Android 17
// Build: CP2A.260705.006
// Kernel: 6.1.157-android14-11-gbd23337e42e7-ab14791245
//
// The July Oriole build uses exact GKI CI build 14791245, shared with the
// bluejay/tegu CP2A.260705.006 targets. Offsets and 6.1 layouts were checked
// against 14791245-vmlinux and device-validated by the standalone Oriole R7
// derivative (stage-0 through cleanup, reconnectable root, and android14-6.1
// ReSukiSU late-load). This modular target is compile-validated separately.
...
#define BUILD_VARIANT_LABEL "oriole-CP2A.260705.006-app"
#else
#define BUILD_VARIANT_LABEL "oriole-CP2A.260705.006-root-umh"
#endif
#ifndef BUILD_FINGERPRINT
#define BUILD_FINGERPRINT "google/oriole/oriole:17/CP2A.260705.006/15641320:user/release-keys"
#endif
