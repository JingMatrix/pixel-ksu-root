...
import os, sys, struct, io, bz2, lzma, urllib.request

# payload_dumper ships a _pb2.py generated by an old protoc, which protobuf 4+
# refuses to load against its C++ implementation ("your generated code is out of
# date"). The pure-Python implementation still accepts it, and the manifest this
# parses is a few hundred KB, so the speed it costs is not measurable here. Set
# before the import, which is when protobuf decides.
os.environ.setdefault("PROTOCOL_BUFFERS_PYTHON_IMPLEMENTATION", "python")

from payload_dumper import update_metadata_pb2 as pb  # noqa: E402
