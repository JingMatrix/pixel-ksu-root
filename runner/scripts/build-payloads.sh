...
# helper from the vendored source under cves/.
#
...
# Locate an Android NDK: ANDROID_NDK_HOME, else ANDROID_NDK_ROOT, else the
# highest-versioned NDK under the SDK named by ANDROID_HOME/ANDROID_SDK_ROOT.
